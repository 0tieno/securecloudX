...
|---------|----------------------------|----------------------|---------|
| **Day 1** | [IAM Fundamentals (Azure AD, RBAC, Conditional Access)](https://learn.microsoft.com/en-us/azure/active-directory/) | [Secure Azure DevOps Pipelines (RBAC, Permissions)](https://learn.microsoft.com/en-us/azure/devops/pipelines/security/) | [ ] |
| **Day 2** | [Azure AD Policies & Privileged Identity Management (PIM)](https://learn.microsoft.com/en-us/azure/active-directory/privileged-identity-management/) | [CI/CD Pipeline Security Best Practices (OWASP)](https://owasp.org/www-project-cicd-security/) | [ ] |
| **Day 3** | [Network Security: Azure NSGs & Firewall](https://learn.microsoft.com/en-us/azure/networking/) | [Secrets Management (Azure Key Vault)](https://learn.microsoft.com/en-us/azure/key-vault/) | [ ] |
| **Day 4** | [Advanced Azure NSG, WAF, and DDoS Protection](https://learn.microsoft.com/en-us/azure/web-application-firewall/) | [Scan repositories for exposed secrets (GitGuardian)](https://www.gitguardian.com/) | [ ] |
| **Day 5** | [Microsoft Defender for Cloud & Azure Policy](https://learn.microsoft.com/en-us/azure/defender-for-cloud/) | [SAST with SonarQube & Azure DevOps](https://docs.sonarqube.org/latest/analysis/scan/sonarscanner-for-azure-devops/) | [ ] |
| **Day 6** | [Logging & Monitoring: Azure Monitor, Log Analytics, Sentinel](https://learn.microsoft.com/en-us/azure/azure-monitor/) | [Secure Infrastructure as Code (Terraform + Checkov)](https://www.checkov.io/) | [ ] |
| **Day 7** | [Compliance Frameworks (CIS Benchmarks, NIST, ISO 27001, Microsoft Cloud Security Benchmark)](https://learn.microsoft.com/en-us/azure/security/fundamentals/compliance-overview) | [Software Composition Analysis (SCA) with Snyk](https://snyk.io/) | [ ] |
| **Day 8** | [Cloud Threat Detection with Microsoft Sentinel](https://learn.microsoft.com/en-us/azure/sentinel/) | [Secure Kubernetes RBAC & Network Policies (AKS)](https://learn.microsoft.com/en-us/azure/aks/cluster-security) | [ ] |
| **Day 9** | [Auditing & Security Logging in Azure](https://learn.microsoft.com/en-us/azure/governance/) | [Container Security (Trivy, Aqua Security)](https://aquasec.com/) | [ ] |
| **Day 10** | [Incident Response & Forensics in Azure Security](https://learn.microsoft.com/en-us/azure/security/fundamentals/threat-detection) | [CI/CD Hardening & Least Privilege](https://owasp.org/www-project-devsecops-maturity-model/) | [ ] |
| **Day 11** | [Serverless Security (Azure Functions & Logic Apps)](https://learn.microsoft.com/en-us/azure/azure-functions/security-concepts) | [SIEM in DevSecOps (Azure Sentinel Integration)](https://learn.microsoft.com/en-us/azure/sentinel/) | [ ] |
| **Day 12** | [Zero Trust Architecture in Azure](https://learn.microsoft.com/en-us/security/zero-trust/) | [Shift-Left Security in CI/CD](https://snyk.io/learn/shift-left-security/) | [ ] |
| **Day 13** | [Azure Policy & Governance (Blueprints, Security Center)](https://learn.microsoft.com/en-us/azure/governance/) | [Secure Dependency Management](https://owasp.org/www-project-dependency-check/) | [ ] |
| **Day 14** | [Multi-Cloud Security Considerations](https://learn.microsoft.com/en-us/security/) | [Continuous Monitoring in DevSecOps](https://owasp.org/www-project-devsecops-maturity-model/) | [ ] |
| **Day 15** | **Midway Review & Recap** | **Midway Review & Recap** | [ ] |
| **Day 16** | [Advanced IAM (Conditional Access, Identity Protection)](https://learn.microsoft.com/en-us/azure/active-directory/) | [Secrets Rotation & Vault Automation](https://learn.microsoft.com/en-us/azure/key-vault/secrets/) | [ ] |
| **Day 17** | [Azure Security Forensics & Log Analysis](https://learn.microsoft.com/en-us/azure/security/) | [Advanced Kubernetes Security (OPA/Gatekeeper)](https://openpolicyagent.org/) | [ ] |
| **Day 18** | [Azure WAF & DDoS Protection](https://learn.microsoft.com/en-us/azure/web-application-firewall/) | [Cloud-Native Security Tools (Falco, Sysdig)](https://sysdig.com/) | [ ] |
| **Day 19** | [Secure Azure Virtual Machines & Workloads](https://learn.microsoft.com/en-us/azure/security/) | [Automate CI/CD Security Tests](https://snyk.io/) | [ ] |
| **Day 20** | **Security Best Practices Recap** | **Compliance as Code (Open Policy Agent)** | [ ] |
| **Day 21-25** | **Final Year Project: Secure CI/CD Pipeline with DevSecOps** | **Final Year Project: Securing OWASP Juice Shop in CI/CD** | [ ] |
