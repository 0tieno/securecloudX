...
export default function AnnouncementBar() {
  return (
    <div
      className="fixed top-2 left-2 right-2 bg-gray-800 border border-red-400 text-gray-300 text-center font-mono text-xs sm:text-sm py-2 sm:py-3 px-2 sm:px-4 z-50 shadow-lg"
