    ...
    return (
      <header className="w-full bg-gray-800 p-4 text-gray-300 shadow-md flex justify-between items-center">
        ...
        <div className="flex items-center space-x-3">
          {/* GitHub Icon */}
          <a href="https://github.com/0tieno" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400">
          ...
          {/* X (Twitter) Icon */}
          <a href="https://x.com/ron_otieno" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
