...
const Sidebar = () => {
  ...
  return (
    <div className="w-64 bg-gray-800 text-gray-300 h-screen flex flex-col border-r border-gray-700">
        ...
        <ul>
            ...
            <li key={day}>
              ...
              {openDay[day] && (
                <ul className="ml-4 border-l-2 border-gray-600">
                  ...
                  <li>
                    <Link to={`/day/${day}/resources`} className="block px-4 py-1 hover:bg-gray-700">
                      Resources
                    </Link>
                  </li>
                </ul>
          ...
          <li>
            ...
            {openNextSteps && (
              <ul className="ml-4 border-l-2 border-gray-600">
                <li>
                  <Link to="/next-steps" className="block px-4 py-1 hover:bg-gray-700">
                    Explore More
                  </Link>
                </li>
              </ul>
