  ...
  return (
    <Content>
      ...
      <div className="mt-6 p-4 bg-gray-800 rounded-lg shadow-md">
        ...
        <p><strong>Goal:</strong> Secure data using encryption, access controls, and backups.</p>
      </div>
      ...
      <div className="mt-6">
        ...
        <div className="mt-4 p-4 bg-gray-800 rounded-lg shadow-md">
          <h4 className="text-xl font-semibold text-blue-400">Enable Data Encryption</h4>
        ...
        <div className="mt-4 p-4 bg-gray-800 rounded-lg shadow-md">
          <h4 className="text-xl font-semibold text-blue-400">Configure Access Control for Storage</h4>
          <ul className="list-disc pl-5 text-gray-300 mt-2">
        ...
        <div className="mt-4 p-4 bg-gray-800 rounded-lg shadow-md">
          <h4 className="text-xl font-semibold text-blue-400">Secure Data in Transit</h4>
          <ul className="list-disc pl-5 text-gray-300 mt-2">
