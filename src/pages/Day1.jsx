...
const Day1 = () => {
  return (
    <Content>
      <h2 className="text-2xl sm:text-3xl font-bold text-gray-300">Day 1: Identity & Access Management (IAM) 🔐</h2>
      ...
      <div className="mt-6 p-4 bg-gray-800 rounded-lg shadow-md">
        <p className="text-sm sm:text-base"><strong>Domain:</strong> Identity & Access Management (IAM)</p>
        <p className="text-sm sm:text-base"><strong>Goal:</strong> Understand how to manage user identities, access controls, and authentication in Azure.</p>
      </div>
      ...
      <div className="mt-6">
        ...
        <div className="mt-4 p-4 bg-gray-800 rounded-lg shadow-md">
          <h4 className="text-lg sm:text-xl font-semibold text-blue-400">Set Up Azure AD (Active Directory)</h4>
        ...
        <div className="mt-4 p-4 bg-gray-800 rounded-lg shadow-md">
          <h4 className="text-lg sm:text-xl font-semibold text-blue-400">Create Users and Groups</h4>
          <ul className="list-disc pl-5 text-gray-300 text-sm sm:text-base mt-2">
        ...
        <div className="mt-4 p-4 bg-gray-800 rounded-lg shadow-md">
          <h4 className="text-lg sm:text-xl font-semibold text-blue-400">Implement Role-Based Access Control (RBAC)</h4>
          <ul className="list-disc pl-5 text-gray-300 text-sm sm:text-base mt-2">
        ...
        <div className="mt-4 p-4 bg-gray-800 rounded-lg shadow-md">
          <h4 className="text-lg sm:text-xl font-semibold text-blue-400">Enable Multi-Factor Authentication (MFA)</h4>
          <ul className="list-disc pl-5 text-gray-300 text-sm sm:text-base mt-2">
