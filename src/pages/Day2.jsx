...
const Day2 = () => {
  return (
    <Content>
      <h2 className="text-3xl font-bold text-gray-300">Day 2: Network Security & Perimeter Defense 🛡️</h2>
      ...
      <div className="mt-6 p-4 bg-gray-800 rounded-lg shadow-md">
        <p><strong>Domain:</strong> Network Security</p>
        <p><strong>Goal:</strong> Secure Azure resources using Virtual Networks, Firewalls, and DDoS protection.</p>
      </div>
      ...
      <div className="mt-6">
        ...
        <div className="mt-4 p-4 bg-gray-800 rounded-lg shadow-md">
          <h4 className="text-xl font-semibold text-blue-400">Create a Virtual Network (VNet)</h4>
        ...
        <div className="mt-4 p-4 bg-gray-800 rounded-lg shadow-md">
          <h4 className="text-xl font-semibold text-blue-400">Set Up Network Security Groups (NSGs)</h4>
          <ul className="list-disc pl-5 text-gray-300 mt-2">
        ...
        <div className="mt-4 p-4 bg-gray-800 rounded-lg shadow-md">
          <h4 className="text-xl font-semibold text-blue-400">Implement Azure DDoS Protection</h4>
          <ul className="list-disc pl-5 text-gray-300 mt-2">
        ...
        <div className="mt-4 p-4 bg-gray-800 rounded-lg shadow-md">
          <h4 className="text-xl font-semibold text-blue-400">Use Azure Firewall</h4>
          <ul className="list-disc pl-5 text-gray-300 mt-2">
