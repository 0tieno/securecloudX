...
const Day4 = () => {
  return (
    <Content>
      <h2 className="text-2xl sm:text-3xl font-bold text-gray-300">Day 4: Application Security in Azure 🛡️</h2>
      ...
      <div className="mt-6 p-4 bg-gray-800 rounded-lg shadow-md">
        <p className="text-sm sm:text-base"><strong>Domain:</strong> Application Security</p>
        <p className="text-sm sm:text-base"><strong>Goal:</strong> Implement security controls for web applications and APIs in Azure.</p>
      </div>
